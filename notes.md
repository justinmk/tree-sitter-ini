...
Here's the C code for a superfast `.ini` parser generated by tree-sitter.  It
has a nice API exposed as a C dynamic library, usable from any language.
How did I do this? This is an experience report with tree-sitter.
